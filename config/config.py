...
key_transport = ['bus', 'trolleybus', 'tram', 'train', 'plane', 'aircraft', 'airplane', 'taxi', 'tickets']
...
# Initialize links
link_template = 'https://docs.google.com/spreadsheets/d/1C-Z0OPYnyKPSjn8_YvrpE4uFIPiw0xQrSTn2OHhPVO4/edit#gid=1785411570'
